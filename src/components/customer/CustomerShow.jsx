...
class CustomerShow extends Component {
    ...
    componentDidMount() {
        ...
        dataProvider(GET_ONE, 'CustomerShow', {id: this.props.match.params.id})
            .then(user => {
    ...
    render() {
        ...
        const record = this.state.user;        

        return (
            <Card>
                <Title title={`امور مالی "${record.firstname} ${record.lastname}"`} />
                <CardContent>
                ...
                <GridContainer style={{marginTop: 50}}>
                    ...
                    <GridItem xs={12} sm={6} md={3}>
                        <Card className={classes.cardBox}>
                            <CardHeader color="success" stats icon>
                                <p className={classes.cardCategory}>نام</p>
                    ...
                    <GridItem xs={12} sm={6} md={3}>
                        <Card className={classes.cardBox}>
                            <CardHeader color="success" stats icon>
                                <p className={classes.cardCategory}>موبایل</p>
                                <p className={classes.cardTitle}>
                    ...
                    <GridItem xs={12} sm={6} md={3}>
                        <Card className={classes.cardBox}>
                            <CardHeader color="success" stats icon>
                                <p className={classes.cardCategory}>مقدار بدهی</p>
                                <p className={classes.cardTitle}>
                    ...
                    <GridItem xs={12} sm={6} md={3}>
                        <Card className={classes.cardBox}>
                            <CardHeader color="success" stats icon>
                                <p className={classes.cardCategory}>مقدار پرداختی</p>
                                <p className={classes.cardTitle}>
                    ...
                    <ReferenceManyField
                        ...
                        target="appUserId"
                        record={{id: this.props.match.params.id}}
                        basePath="/"
                        fullWidth
                    >
                        <Datagrid>
                            ...
                            <FunctionField label="شماره فاکتور" source="factorCode" render={
                                record => record.factors === null ? '' : record.factors.length > 0 ? record.factors[0].id : ''
                            }/>
...
export default withRouter(connect(
    null, {
})(withStyles(styles)(CustomerShow)));